...
function VertiLine(props) {
  ...
  switch (props.pOneIsNext) {
    case false:
      classSwitch = 'orangeLine';
      break;
    case true:
      classSwitch = 'greenLine';
      break;
    default:
      break;
  }
  ...
  return (
    <button
      className={'verti-line line ' + classSwitch}
...
function HoriLine(props) {
  ...
  return (
    <button
      className={'hori-line line ' + classSwitch}
      onClick={props.onClick}
      style={props.style}
    >
      {props.value}
...
class Board extends React.Component {
  ...
  render() {
    return (
      <div>
        <div className="board-row hori-row">
          {this.renderHoriLine(0)}
          {this.renderHoriLine(1)}
          {this.renderHoriLine(2)}
        </div>
        <div className="board-row verti-row">
